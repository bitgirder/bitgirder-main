...
class CryptoTests
{
    ...
    //
    //  $ echo "sign-this-string" | openssl dgst -sha1 -hmac 'uV3F3YluFJax1cknvbcGwgjvx4QpvB+leU8dUj2o'
    //
    @Test
    private
    void
    testHmacSha1()
        throws Exception
    {
        SecretKey key = CryptoUtils.asSecretKey( TEST_KEY_ASCII, "HmacSHA1" );
        ...
        state.equalString( 
            "91190c2a40aa8ed9ecdc5f27fe0c231c7e0776f4", 
