...
// Autogenerated on 2014-03-05 15:17:59 -0800 by script at end of this file
...
func ( acc *SymbolMapAccessor ) GetBooleanById(
    ...
    if err == nil {
        val, err = accSupportCast( val, TypeBoolean, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetBufferById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeBuffer, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetStringById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeString, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetInt32ById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeInt32, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetInt64ById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeInt64, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetUint32ById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeUint32, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetUint64ById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeUint64, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetFloat32ById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeFloat32, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetFloat64ById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeFloat64, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetTimestampById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeTimestamp, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetSymbolMapById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeSymbolMap, acc.descend( id ) )
...
func ( acc *SymbolMapAccessor ) GetListById(
    ...
    val, err = acc.GetValueById( id )
    if err == nil {
        val, err = accSupportCast( val, TypeOpaqueList, acc.descend( id ) )
...
//         [ "val, err = accSupportCast( val, #{cast_type}, acc.descend( id ) )" ]
//     end
// 
//     <<-FUNCS
