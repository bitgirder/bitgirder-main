...
func init() {
    ...
    CoreParseTests = append( CoreParseTests,
        ...
        idPathSucc( 
            "capStuff.dash-stuff.underscore_stuff", 
            "cap-stuff.dash-stuff.underscore-stuff",
            objpath.RootedAt( id( "cap", "stuff" ) ).
                Descend( id( "dash", "stuff" ) ).
        ...
        idPathFail( "", 1, "Unexpected end of input" ),
        idPathFail( "bad$Id", 4, "Invalid id rune: \"$\" (U+0024)" ),
        idPathFail( "[ 1 ].bad$Id", 10, "Invalid id rune: \"$\" (U+0024)" ),
        idPathFail( ".stuff", 1, 
            "Expected identifier or list index but found: ." ),
        idPathFail( "#stuff", 1, "Unexpected comment start" ),
        idPathFail( "i1[ 2", 6, "Expected ] but found: END" ),
        idPathFail( "[ -1 ]", 3, "negative list index" ),
        idPathFail( "i1[ -2.0 ]", 5, "negative list index" ),
        idPathFail( "i1[ 1.0 ]", 5, "invalid decimal index: 1.0" ),
        idPathFail( "i1[ 1e1 ]", 5, "invalid decimal index: 1e1" ),
        idPathFail( "i1[ 1.1e1 ]", 5, "invalid decimal index: 1.1e1" ),
        idPathFail( "i1[ 9999999999999999999999999999999999999 ]", 5,
            "list index out of range" ),
        idPathFail( "i1[ xx ]", 5, "Expected numeric token but found: xx" ),
        idPathFail( "i1.2", 4, "Expected identifier but found: 2" ),
        idPathFail( "i1..i2", 4, "Expected identifier but found: ." ),
        idPathFail( "[]", 2, "Expected numeric token but found: ]" ),
        idPathFail( "i1[ ]", 5, "Expected numeric token but found: ]" ),
        idPathFail( "i1[ 1 )", 7, "Expected ] but found: )" ),
        idPathFail( "i1( 1 )", 3, 
            "Expected identifier or list index but found: (" ),
        idPathFail( "i1.[2]", 4, "Expected identifier but found: [" ),
        idPathFail( "[ 1 ].[ 2 ]", 7, "Expected identifier but found: [" ),
        idPathFail( "i1;i2", 3, 
            "Expected identifier or list index but found: ;" ),
        idPathFail( "i1[ 2 ]i3", 8, 
            "Expected identifier or list index but found: i3" ),
        idPathFail( "i1 i2", 4, 
            "Expected identifier or list index but found: i2" ),
    )
